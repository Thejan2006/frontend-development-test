...
export default function RegisterPage(){
    ...
    return (
        <div className="w-full min-h-[calc(100vh-80px)] bg-slate-50 flex justify-center items-center p-6 py-10">
            <div className="w-full max-w-md bg-white shadow-sm rounded-2xl border border-slate-200 p-8">
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex gap-4">
                        ...
                        <div className="flex-1">
                            <label className="text-slate-700 text-sm font-semibold block mb-2">Last Name</label>
                            <input 
                                className="w-full h-11 px-4" 
                                type="text" 
                                placeholder="Doe"
                    ...
                    <div>
                        <label className="text-slate-700 text-sm font-semibold flex items-center gap-2 mb-2"><BiKey size={18} className="text-slate-400"/> Confirm Password</label>
                        <input
                ...
                <button 
                    disabled={loading} 
                    className="btn-primary w-full h-12 flex items-center justify-center mt-8" 
                ...
                >
                    <BsGoogle size={18} className="text-red-500"/> Sign Up with Google
                </button>

                <p className="text-center text-slate-500 text-sm mt-8">
                    Already have an account? <Link to="/signin" className="font-semibold text-blue-600 hover:text-blue-700 transition-colors">Sign in</Link>
                </p>
            </div>
        </div>
    )
